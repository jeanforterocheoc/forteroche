...
<div class="row">
    <div class="col-lg-12">
        <ul class="pagination pagination-lg">
            ...
            <?php else : ?>
                <li class="page-item">
                    <a href="admin/commentsReported?page=<?=$currentPage - 1 ?>"><i class="fas fa-arrow-alt-circle-left"></i></a>
                </li>
                <br>
            <?php endif;?>
            <?php 
            ...
            <?php else : ?>
                <li class="page-item">
                    <a href="admin/commentsReported?page=<?= $i ?>"><i><?= $i ?></i></a>
                </li>
                <br>
            <?php endif; 
            } ?> <!-- Fin boucle -->
            ...
            <?php else : ?>
                <li class="page-item">
                    <a href="admin/commentsReported?page=<?=$currentPage + 1 ?>"><i class="fas fa-arrow-alt-circle-right"></i></a>
                </li>
                <br>
            <?php endif; ?>     
        </ul>
