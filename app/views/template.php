...
<html lang="fr">
  <head>
    ...
    <link rel="icon" href="public/images/favicon/favicon.png" type="image/png">
    <link rel="icon" sizes="32x32" href="public/images/favicon/favicon-32.png" type="image/png">
    <link rel="icon" sizes="64x64" href="public/images/favicon/favicon-64.png" type="image/png">
    <link rel="icon" sizes="96x96" href="public/images/favicon/favicon-96.png" type="image/png">
    <link rel="icon" sizes="196x196" href="public/images/favicon/favicon-196.png" type="image/png">
    <link rel="apple-touch-icon" sizes="152x152" href="public/images/favicon/apple-touch-icon.png">
